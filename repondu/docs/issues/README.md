...
| [C2](C2-sequence.md) | Séquence J0 / J+3 / J+8, boîtes, quotas, opt-out | `feat/C2-sequence` | à faire |
| [C3](C3-multichannel.md) | Formulaire (Playwright), DM via Telegram, SMS | `feat/C3-multichannel` | à faire |
